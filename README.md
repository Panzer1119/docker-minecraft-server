...
- [Data Directory](#data-directory)
    ...
    - [Locating filesystem path of anonymous volume](#locating-filesystem-path-of-anonymous-volume)
- [Versions](#versions)
...
- [Server types](#server-types)
    ...
    - [Running a Folia server](#running-a-folia-server)
...
- [Running a server with a Modrinth modpack](#running-a-server-with-a-modrinth-modpack)
...
- [Running a server with a CurseForge modpack](#running-a-server-with-a-curseforge-modpack)
    - [Auto CurseForge Management](#auto-curseforge-management)
...
- [Working with mods and plugins](#working-with-mods-and-plugins)
    ...
    - [Auto-downloading SpigotMC/Bukkit/PaperMC plugins with Spiget](#auto-downloading-spigotmc-bukkit-papermc-plugins-with-spiget)
    - [Auto-download mods from Modrinth](#auto-download-mods-from-modrinth)
...
- [Working with world data](#working-with-world-data)
    ...
    - [Custom worlds directory path](#custom-worlds-directory-path)
    - [Datapacks](#datapacks)
...
- [Server configuration](#server-configuration)
    ...
    - [Enable/disable initial selection of datapacks](#enable-disable-initial-selection-of-datapacks)
...
- [Miscellaneous Options](#miscellaneous-options)
    ...
    - [Enable support for optimized SIMD operations](#enable-support-for-optimized-simd-operations)
    - [Enable timestamps in init logs](#enable-timestamps-in-init-logs)
    - [Auto-execute RCON commands](#auto-execute-rcon-commands)
- [Autopause](#autopause)
    - [Description](#description)
    - [Enabling Autopause](#enabling-autopause)
    - [Rootless Autopause](#rootless-autopause)
- [Autostop](#autostop)
